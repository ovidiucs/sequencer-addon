...
def draw_shot_strip(
    ...
    # Using Blender's system DPI setting
    system_dpi = bpy.context.preferences.system.dpi
    blf.size(font_id, int(11 * bpy.context.preferences.system.ui_scale), system_dpi)
